...
public class Microwave extends BlockContainer
{
	private static final AxisAlignedBB BOUNDING_BOX = new AxisAlignedBB(0D, 0D, 0D, 1D, 0.6875D, 0.875D);
    ...
    public Microwave(String name, boolean isBurning)
    {
        super(Material.ROCK);
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
    	if(!worldIn.isRemote)
    	{	
    		playerIn.openGui(TestMod.instance, Reference.GUI_MICROWAVE, worldIn, pos.getX(), pos.getY(), pos.getZ());
    	}
